...
% Paths to change to your local environment:
...
ZS = loadZSData2017(language,audio_location); % Load Mandarin data files
...
%% Now, the data can be read in Python with:
% 
% import scipy,scipy.io
% 
% if(os.path.isdir('/Users/rasaneno/rundata/ZS2020_tmp/')): % <-- FIX PATHS
%     datadir = '/Users/rasaneno/rundata/XSL_LSTM_data/'
% elif(os.path.isdir('/home/rasaneno/speechdb/ZS2020_tmp/')):
%     datadir = '/home/rasaneno/speechdb/ZS2020_tmp/'
% 
% 
% language = 'mandarin'
% 
